...
class UniversalBillClassifier:
    ...
    PRODUCT_KEYWORD_MAPPING = {
        ...
        '餐饮': [
            '外卖', '外卖订单', '咖啡', '奶茶', '零食', '小吃',  '食在宣',
            '餐厅', '饭店', '食堂', '快餐', '餐饮店', '雪糕', '小笼包',
            '成都膳百味餐饮有限公司', '龙户人家', '浏阳蒸菜', '麻辣烫', '蜜雪冰城',
            '真霸牛肉', '轩味轩', '乐意豌杂面', '三餐馆子', '调夫五味', '喜利来'
        ],
        '日用品': [
            '超市', '便利店', '购物', '日用', '生活用品', '小红书',
            '店内购物', '满彭菜场', '集刻便利店', '盒马鲜生', 
            '天猫超市', '永辉', '龙湖','抖音电商', '美宜佳', '沃尔玛',
        ],
        '美妆': [
            '快剪', '理发'
        ],
